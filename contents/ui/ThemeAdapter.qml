...
QtObject {
    ...
    property string mode: plasmoid.configuration.colorTheme || "original"
    ...
    property color sysOrange: Kirigami.Theme.highlightColor // Typically Accent/Focus
    ...
    // Effective Palette (forced to string to avoid Canvas parsing issues)
